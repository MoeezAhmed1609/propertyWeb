      ...
      <div className="printpage__parent ">
        ...
        <div className='PPdiv__Header'>
          ...
          <div className="ppheader__text">
            <p>Limited Cash Offer! Little Bosphorus investment historic Istanbul Centre</p>
          </div>
        ...
        <div className='PPpictures__parent1 mb-2'>
          <img src={'https://www.propertyturkey.com/front/image/home/tab-backgrounds/bg-tab-3.jpg'} alt="" />
        </div>
        <div className='PPpictures__parent2 mb-2'>
          <img src={'https://www.propertyturkey.com/front/image/home/tab-backgrounds/bg-tab-4.jpg'} alt="" />
          <img src={'https://www.propertyturkey.com/front/image/home/tab-backgrounds/bg-tab-4.jpg'} alt="" />
        </div>
