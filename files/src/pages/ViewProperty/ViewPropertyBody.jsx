    ...
    <>
      <div className="pt-tv-bg padding-top-3">
        <div className="wrap-dis-9 wrap-tab-12 wrap-mob-12 clearfix property-end">
          <article
            className="clearfix padding-bottom-4"
            itemScope=""
            style={{}}
          >
            <span
              className=" Contact__form col-dis-3 col-tab-12 col-mob-12 property_right_side"
              id="reachtoform-end"
            >
              <div
                id="enquire_form_end"
                className="property-price-box align-dis-right align-tab-right align-mob-left enquire-box"
              >
                <div
                  className="cameron-header"
            ...
            <div className="Hide" style={{ display: "none" }}>
              ...
              <div className="card-actions flex padding-1 content-space-between">
                <div
                  className="price flex-ver-hor-cen-sm"
                  sp-slide
                  sp-selected
                  itemProp="offers"
                  itemScope=""
                ...
                >
                  <span className="unit-price flex content-center">
                    $1,600,000
                  </span>
              ...
              <Link
                to=""
                className="add_enquire  scrollToForm btn col-dis-12 col-tab-12 col-mob-12"
              >
            ...
            <section className="property_features col-dis-9 col-tab-12 col-mob-12 clearfix">
              <div className="roomcard-desc">
                <div className="flex-xl">
                  <div
                    className="col-12 col-md-3 flex col content-center pt-about-title"
                    style={{ padding: 0 }}
                  >
                    <span>
                      Property
                  ...
                  <div className="col-12 col-md-3  border-left-greyline property_features--centercontent flex content-start">
                    <div className="cf">
                      ...
                      Living space sqm:
                      <span className="cf--title">
                        {ImagesData.Propert_Living_space}
                      </span>
                    </div>
                    <div className="cf">
                      ...
                      Pool:
                      <span className="cf--title">
                        {ImagesData.property_pool}
                      </span>
                    </div>
                  </div>
                </div>
                <div
                  className="widget widget-why-buy col-dis-6 col-tab-12 col-mob-12 hide"
                  style={{}}
                >
                ...
                <div
                  className="widget widget-features col-dis-6 col-tab-12 col-mob-12 hide"
                  style={{}}
                >
                  <h3 className="title" style={{}}>
                    Why buy this
            ...
            <div
              className="area property-area col-dis-9 col-tab-12 col-mob-12 d-desk"
        ...
        <div className="bg-white related-pt d-desk padding-ver-1">
          <section
            id="new-properties"
            className="wrap-dis-9 wrap-tab-9 wrap-mob-9"
          >
        ...
        <div
          className="area property-area col-dis-9 col-tab-12 col-mob-12 d-mobile"
          id="property-areas"
          itemProp="description"
          clearfix=""
        >
          ...
          <div className="bg-white related-pt d-mobile">
            ...
            >
              ...
              <div
                className="cf related-pt-container owl-carousel carousel owl-images-initialized owl-loaded owl-drag"
                items={4}
                margin={10}
                touch={1}
              >
                <div className="owl-stage-outer">
                  ...
                  >
                    <div className="owl-item">
                      <div
                        type=""
                        className="related-pt-card property-box  cf hot-property "
                        hot="Hot Property"
                      >
                        <link
                          itemProp="additionalType"
                          to="https://www.productontology.org/id/Condominium"
                        />
                        <div className="position-relative">
                          ...
                          <meta
                            itemProp="name"
                            content="Bosphorus and Istanbul skyline view apartment in Sisli"
                          />
                              ...
                              >
                                <div className="owl-item">
                                  <Link rel="nofollow" to="">
                                    <Image
                                      className="owl-lazy"
                                      data-src="https://www.propertyturkey.com/uploads/realestate/5181/thumb/istanbul_apartment_5-300x200.jpeg"
                                      alt="Modern residence"
                                      src="https://www.propertyturkey.com/uploads/realestate/5181/thumb/istanbul_apartment_5-300x200.jpeg"
                                      style={{ opacity: 1 }}
                                    />
                                  </Link>
                                </div>
                          ...
                          <Link
                            to=""
                            title="Bosphorus and Istanbul skyline view apartment in Sisli"
                            className="property-title abhaya"
                          >
                            Bosphorus and Istanbul skyline view apartment in
                            Sisli
                          </Link>
                          ...
                          <div className="card-actions flex padding-1 content-space-between">
                            ...
                            <div>
                              <Link
                                className="btn --circle heart-label"
                                id="inline"
                                to="#logins2"
                                data-id={5181}
                              >
                          ...
                          <div className="features">
                            <div className="location">
                              <Image
                                className="icon-location Image-fluid"
                            ...
                            <div className="bedrooms flex content-space-evenly">
                              <div>
                                <Image
                                  className="icon-bedroom Image-fluid"
                            ...
                            <div className="bathrooms flex content-space-evenly">
                              <div>
                                <Image
                                  className="icon-bathrooms Image-fluid"
                        ...
                        <meta
                          itemProp="url"
                          content="https://www.propertyturkey.com/real_estate/5181-bosphorus-and-istanbul-skyline-view-apartment-in-sisli"
                        />
                      </div>
                    </div>
                    <div className="owl-item">
                      <div
                        ...
                        type=""
                        className="related-pt-card property-box  cf  "
                        hot="Hot Property"
                      >
                        <link
                          itemProp="additionalType"
                        ...
                        <div className="position-relative">
                          ...
                          <meta
                            itemProp="name"
                            content="Luxury hotel-style Crown of Bomonti Sisli apartments"
                          />
                          <figure className="card-imageSlider owl-carousel card-imageSlider--carousel owl-images-initialized owl-loaded">
                            <div className="owl-stage-outer">
                              <div
                              ...
                              >
                                <div className="owl-item">
                                  <Link rel="nofollow" to="">
                                    <Image
                                      className="owl-lazy"
                                      data-src="https://www.propertyturkey.com/uploads/realestate/2398/thumb/crown_bomonti_1-300x200.jpeg"
                                      alt="Crown of Bomonti property"
                                      src="https://www.propertyturkey.com/uploads/realestate/2398/thumb/crown_bomonti_1-300x200.jpeg"
                                      style={{ opacity: 1 }}
                                    />
                                  </Link>
                                </div>
                          ...
                          <Link
                            to=""
                            title="Luxury hotel-style Crown of Bomonti Sisli apartments"
                            className="property-title abhaya"
                          >
                        ...
                        <meta
                          itemProp="url"
                          content="https://www.propertyturkey.com/real_estate/2398-luxury-hotel-style-crown-of-bomonti-sisli-apartments"
                        />
                      </div>
                    </div>
                    <div className="owl-item">
                      ...
                      >
                        ...
                        <div className="position-relative">
                          ...
                          <meta
                            itemProp="name"
                            content="Elite Nisantasi apartments for 5-star luxury living"
                          />
                          <figure className="card-imageSlider owl-carousel card-imageSlider--carousel owl-images-initialized owl-loaded">
                            <div className="owl-stage-outer">
                              <div
                              ...
                              >
                                <div className="owl-item">
                                  <Link rel="nofollow" to="">
                                    <Image
                                      className="owl-lazy"
                                      data-src="https://www.propertyturkey.com/uploads/realestate/larg/nisantasi_apartment_1_1.jpg"
                                      alt="Nisantasi luxury apartment for sale"
                                      src="https://www.propertyturkey.com/uploads/realestate/larg/nisantasi_apartment_1_1.jpg"
                                      style={{ opacity: 1 }}
                                    />
                                  </Link>
                                </div>
                          ...
                          <Link
                            to=""
                            title="Elite Nisantasi apartments for 5-star luxury living"
                            className="property-title abhaya"
                          >
                          ...
                          <div className="card-actions flex padding-1 content-space-between">
                            <div className="price">
                              ...
                              <meta
                                ...
                                content="$1,571,400"
                              />
                              <meta itemProp="price" content={1434000.0} />
                            </div>
                            <div>
                              <Link
                                className="btn --circle heart-label"
