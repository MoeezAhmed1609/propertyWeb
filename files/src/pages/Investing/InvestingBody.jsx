...
export default function InvestingBody() {
  ...
  const [togglePurchaseProcess, settoggletogglePurchaseProcess] = useState(false);
        ...
        <div className="col-12 col-md-3 buyer-guide--side-bar-bg">
          <div className="container-fluid">
            ...
            <div className="padding-top-2 side-item">
              ...
              <ul className={`list-unstyled buyer-guide--ul ${toggleInvesting ? '' : 'hide'}`}>
                <li className="active">
                  <Link
                    to=""
            ...
            <div className="padding-top-2 side-item">
              <div className="buyer-guide--supertitle">
                ...
                <i onClick={() => settoggletogglePurchaseProcess(!togglePurchaseProcess)} className={`${togglePurchaseProcess?'fa fa-angle-down':'fa fa-angle-up'}  tabs-icon`} aria-hidden="true" />
              </div>
            ...
            <div className="padding-top-2 side-item">
              <div className="buyer-guide--supertitle">
                ...
                <i onClick={() => settoggletoggleResidency(!toggleResidency)} className={`${toggleResidency?"fa fa-angle-down":"fa fa-angle-up"}  tabs-icon`} aria-hidden="true" />
              </div>
            ...
            <div className="padding-top-2 side-item">
              <div className="buyer-guide--supertitle">
                ...
                <i onClick={() => setpets(!togglepets)} className={`${togglepets?"fa fa-angle-down":"fa fa-angle-up"}  tabs-icon`} aria-hidden="true" />
              </div>
            ...
            <div className="padding-top-2 side-item">
              <div className="buyer-guide--supertitle">
                ...
                <i onClick={() => setProperty(!toggleProperty)} className={`${toggleProperty?"fa fa-angle-down":"fa fa-angle-up"}  tabs-icon`} aria-hidden="true" />
              </div>
            ...
            <article className="page-content">
              <div className="areabody clearfix" itemProp="articleBody">
                <p>
                  ...
                  a population of approximately 80 million as at 2017, and a high
                  proportion of that being young and upwardly mobile, USA is an
                  ideal country for investors who want to take advantage of a
                  fast-developing real estate industry.&nbsp;
                </p>
                <p>
                  <span style={{ lineHeight: "1.6em" }}>
                    ...
                    sixth in the world in terms of its annual price growth index,
                    with a year-on-year increase of more than 11%, head of Australia
                    and India.
                  </span>
                </p>
                <p>
                  <span style={{ lineHeight: "1.6em" }}>
                    Istanbul has been touted by PWC and Deloitte Consulting to be
                    the most attractive city for real estate investment in Europe.
                    USA overall is ranked&nbsp;
                  </span>
                  3rd
                  <span style={{ lineHeight: "1.6em" }}>
                ...
                <p>
                  <span style={{ lineHeight: "1.6em" }}>
                    More important is also the legislative amendments that have been
                    done to several laws including the{" "}
                    <a>
                      property title registry law
                    </a>
                    , the mortgage law,{" "}
                    <a>
                      residency
                ...
                <p>
                  Dynamic demographic factors and good economic figures have enabled
                  USA to increasingly become the choice for foreign investors
                  interested in setting up businesses and purchasing real estate.
                  There has been an increase in demand for homes and offices in the
                  recent years as more global companies and foreigners demand
                  ...
                  institutionalised
                  <span style={{ lineHeight: "1.6em" }}>
                    &nbsp;the sector while it has also put in place transparency and
                    high quality standards in property transactions in anticipation
                    of joining the&nbsp;
                  </span>
                  EU<span style={{ lineHeight: "1.6em" }}>.&nbsp;</span>
                </p>
                <p>
                  <span style={{ lineHeight: "1.6em" }}>With a GDP of&nbsp;</span>
                  USD
                  <span style={{ lineHeight: "1.6em" }}>
                    &nbsp;851 billion in 2017, and 60% of the population under 40
                    years old, USA has become a major target for foreign direct
                    investment.&nbsp;
                  </span>
                </p>
                <p>
                  <span style={{ lineHeight: "1.6em" }}>
                    Banks and mortgage firms have also increased lending, with over
                    100 billion being disbursed in 2018. USA also attracted one
                    of the highest numbers of tourists in 2018, with almost 46
                    million tourists visiting, making the country the sixth most
                    popular destination on the planet
                  </span>
                  <span style={{ lineHeight: "1.6em" }}>
                    . The high number of tourists indicates the high potential that
                    USA has in the holiday home purchase and rentals segments.
                    This is attributed to the fact all these tourists will need
                    somewhere to stay whether homes or hotels.
                  </span>
                </p>
                <p>
                  USA is an economic regional hub providing ultra modern shopping
                  centres, and easy access to over 1.5 billion people who come for
                  trade and other services in the country. This has increased the
                  demand for infrastructure and facilities in the country.
                </p>
                <p>
                  <br />
                </p>
                ...
                <table width="100%">
                  <tbody>
                    ...
                    <tr>
                      <td>
                        - USA is the leading investment country in Europe for GDP
                        growth projections. <br />- Strong financial and banking
                        regulations. <br />- Construction companies with global
                        reputation. <br />- Access to mortgage facilities. <br />-
                        Government adding more buyer incentives each year. <br />-
                        Strong domestic demand for real estate
                        <br />
                      </td>
                      <td>
                        - Acquiring land is difficult and obtaining construction
                        permits is not straight forward. <br />- High number of old
                        type of housing which cannot qualify for mortgage
                        facilities. <br />
                      </td>
                      <td>
                        - High internal demand for residential housing and
                        commercial space. <br />- Urban regeneration projects in
                        major cities are creating opportunities for new housing.{" "}
                        <br />- Regulations on earthquake and natural disasters have
                        increased the need for quality construction. <br />-
                        Increased tourists inflow and investors have made
                        opportunities for office space and residential property.{" "}
                        <br />
                      </td>
                      <td>
                ...
                <p>
                  ...
                  <strong>
                    <em>
                      Between 2002 and 2016 it has shown a GDP growth of about 4%pa
                    </em>
                  </strong>{" "}
                ...
                <p>
                  ...
                  increased to USD 27,500 in 2017. This shows that the country is on
                  an upward trend, as fortunes for its citizens improve.
                </p>
                <p>
                ...
                <p>
                  ...
                  all increased the appetite for tourism. In 2018, 46 million
                  tourists visited the country realising foreign income in excess of
                  USD $30 billion.&nbsp;
                </p>
                <p>
                ...
                <p>
                  ...
                  pluralistic laws. It was established in 1923 and first adopted its
                  constitution in 1924, and its current constitution was adopted in
                  1982. Before 2018 the country ran under a parliamentary system,
                  but following a referendum, the country's politics now take place
                  within a presidential system. Under the presidential system, the
                  President of USA is the head of government and the head of
                  state, with powers to issue executive decrees, appoint judges and
                ...
                <p>
                  ...
                  projections in excess of 5%, 20th largest economy in the world
                  with exports reaching USD168 billion makes USA the ideal
                  country to invest in real estate.&nbsp;
                </p>
                <p>
                  <em>
                ...
                <p>
                  ...
                  population of educated, wealthy professionals. Tourist arrivals
                  reached 46 million in 2018. This creates an ideal investment
                ...
                <p>
                  ...
                  well developed air, land and sea transport, advanced energy sector
                  and highly developed technological infrastructure in
                  transportation and communication puts USA well ahead of other
                  emerging as the place to invest safely and profitably.
                </p>
                <p>
                  <br />
                </p>
                ...
                <h2>
                  <span style={{ lineHeight: "1.6em" }}>
                    Benchmarking USA to France, UK, Russia, Greece and US&nbsp;
                  </span>
                </h2>
                <p>
                  <img
                ...
                <p>
                  ...
                  give you an in depth analysis on why it is the ideal investment
                  destination for real estate developers and individual overseas
                  property buyers. UK, US, France, Russia and Greece are some of the
                  countries that compete with USA for investment
                  opportunities.&nbsp;
                </p>
                <p>
                  <span style={{ lineHeight: "1.6em" }}>
                    <strong>In the finance and banking sector</strong>, USA has
                    one of the strongest banking regulations while Greece has the
                    least. It is ahead of France and Russia and only slightly below
                    the UK in terms of finance and banking regulations and skilled
                    workforce. This brings higher investor confidence and supports
                    foreign direct investment. The fact that USA imposes no
                    restrictions on funds flows to and from USA helps money-flows
                    a great deal easier and safer. USA also has the best banking
                    sector and finance manpower skills compared to the BRICS
                    (Brazil, Russia, India, China and South Africa). The majority of
                    the population being the youth, they are well trained in various
                    sectors and have strong technical skills.
                  </span>
                </p>
                <p>
                  <strong>
                    USA also leads in Globalisation, Flexibility and Adaptability
                  </strong>{" "}
                  compared to US, Russia, France and Greece. It has opened its doors
                  for other countries to invest which in turn has enabled it get
                  more foreign capital and direct investments. Attitudes toward
                  globalisation are international trade are more viable than
                  countries benchmarked to.&nbsp;
                </p>
                <p>
                  <strong>
                  ...
                  can now register a joint stock company or limited liability
                  company. The New TCC also eliminates the need for foreigners to
                  secure minority shareholders before having their companies to be
                  registered. You can also register your company in one single day
                  and it becomes a legal entity provide you apply with all the
                ...
                <p>
                  ...
                  stands to be more lucrative than in US, France, Greece, Russia and
                  other EU countries. The Republic of USA has made all efforts to
                  make it as simple as possible for real estate investors to
                  participate and support the growth of the country. You are likely
                  to generate higher return on investment in USA than any other
                  country in the EU and most other countries globally.&nbsp;
                </p>
                <p>
                  <img
                    style={{ width: 1200, height: 550 }}
