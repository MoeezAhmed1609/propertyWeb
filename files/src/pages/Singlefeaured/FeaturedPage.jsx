  ...
  return (
    <div className="page-content-container wrap-dis-9 wrap wrap-tab-11 wrap-mob-11 ">
      <article className="page-content col-dis-9 col-tab-9 col-mob-12 no-padding">
        ...
        >
          <p>
            Published by The London Magazine on April 30th 2014, Zoe Dare Hall
            takes us around the world looking at safe, and emerging destinations
            to invest in real estate – asking the question: are you a safe bet?
            Or more of a gambler?&nbsp;
          </p>
          <p>
            The last five years have been a topsy turvy time for many
            international economies, meaning that investing in real estate
            overseas has become more of a skill than it was before – those ‘in
            the know’ and those with a knack for picking the right time and
            right moment to invest – however there is still a fine line between
            a safe bet and an upcoming destination.&nbsp;
          </p>
          <p>
          ...
          <p>
            The difference between the safe bets and the upcoming destinations
            is that while the safe bets have been popular for years and have
            bounced back in recent years following the economic crisis, the up
            and comers have been reaping benefits from huge projects, growing
          ...
          <p>
            ...
            Florida real estate market over the last couple years following the
            huge economical struggles by the US in recent times – the 1000
            Museum project priced from 4 million Dollars and upwards has seen
            more investment into Florida coming from overseas markets such as
            Brazil and China who are continuing to invest in infrastructure in
            the area and beyond.&nbsp;
          </p>
          <p>
            Skyscrapers in Miami and the brand new Miami Worldcenter are set to
            see Florida’s continued resurgence continue and are selling well
            into the millions - a sunny destination within an English speaking
            country, Florida will always prove to be popular amongst
            Brits.&nbsp;
          </p>
          <p>&nbsp;</p>
          <h5>Spain:</h5>
          <p>
            ...
            retirement spots. Tourist destinations like Barcelona, the
            Balearics, and Marbella are beginning to rise once again thanks to
            Spain’s new ‘golden visa’ system that will see any non-EU citizen
            who spends over 500,000 Euros on a property automatically gain
            residency to Spain.&nbsp;
          </p>
          <p>
            A large mansion in Spain will still set you back several millions,
            however smaller villas in Spain have seen dramatic price cuts in
            recent years of up to 60 percent due to Spain’s economy, so you can
            now find four bedroom villas from as little as 400,000 euros in
            Spain – something to tempt the Brit looking to retire, but perhaps
            scaring away some investors to look at the up and comers
            below.&nbsp;
          </p>
          <p>&nbsp;</p>
          ...
          <p>
            ...
            Stanford was jailed and the economic crunch bit hard, a new
            government system is leading the way for Antigua’s upcoming property
            market.&nbsp;
          </p>
          <p>
            ...
            attracting plenty of investors and those looking to retire to a
            sunny destination. High end property can cost into the millions such
            as the Pearns Point development or Jolly Harbour plots selling for
          ...
          <p>
            ...
            become the focal point of South Africa’s growing market for
            properties. No 2 Silo a brand new eco-friendly apartment scheme and
            beachfront homes such as Camps Bay Beach are offering exquisite
            views across the city and are selling fast.&nbsp;
          </p>
          <p>
            With the British economy standing in a good position at the moment
            against many foreign economies, the pound is stretching further, up
            to 36 percent further in South Africa when compared with just a year
            ago.&nbsp;
          </p>
          <p>&nbsp;</p>
          <h4>Final word:</h4>
          <p>
            Whether you are a gambler or a safe bet purchaser, it is still
            possible to find plenty of options to purchase real estate abroad
            today – all five destinations listed by The London Magazine offer
            something different, something unique to each other, an opportunity
            to step on the overseas real estate ladder at a time when the global
