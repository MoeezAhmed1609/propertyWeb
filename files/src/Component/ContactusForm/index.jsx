      ...
      <section className="col-dis-8 col-tab-8 col-mob-12 fl-dis-right fl-tab-right">
        ...
        >
          ...
          <label className="field">
            <b>Name:</b>
            <input name="full_name" type="text" onChange={(e) => setName(e.target.value)} />
          </label>
          ...
          <label className="field">
            ...
            <input name="email" onChange={(e) => HandleEmailCheck(e.target.value)} type="email" validation="email" />
          </label>
          <label className="field">
            <b>Subject:</b>
            <select name="subject" className="subject hidden-field" onChange={(event) => setSelectedValue(event.target.value)}>
          ...
          <label className="field">
            <b>Message:</b>
            <textarea onChange={(e) => setMessage(e.target.value)} name="msg" rows={4}  />
          </label>
          <input
            type="text"
            name="conTactUS"
              ...
              <>
                <div className="officelocation">
                  ...
                  <label>
                    E-mail:{" "}
                    <b className="">
                      <Link className='text-[#5081ff]' to="" >{item.Email}</Link>
                    </b>
                  </label>
                </div>
                <hr />
