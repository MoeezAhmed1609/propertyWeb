    ...
    return (
        <Box className="sec-about flex flex-direction-column lg:px-0 md:px-0 sm:px-1">
            <Typography varient="p" className="aboutpt-header text-center abhaya">
                <strong className='text-5xl' style={{ lineHeight: "3.5rem",display:'block' }}>Property USA</strong>
                <i className="font-24">for lifestyle &amp; investment</i>{" "}
            </Typography>
            <Box className="col-md-10 mx-auto margin-bottom-3 mb-3 text-center">
                <p className="text-2xl">
                Since 2001, <span className='font-bold text-gray-500'>Property USA</span>  has helped clients from all over the world buy<span className='font-bold text-gray-500'>Turkish
                properties</span> in all regions of Turkey. From lifestyle buyers wishing to <span className='font-bold text-gray-500'>buy a property 
                in  USA for sale,</span> to discerning investors seeking to buy property in Turkey, 
                our range of luxury villas, sea view penthouse apartments,  USA houses,
                and unique hotels for sale ensure a range of lifestyle and investment opportunities
                to suit any requirement. Trusted for over 20 years, our portfolio of <span className='font-bold text-gray-500'>houses for sale in  USA </span>  
                    ...
                    <ElasticSlider ItemShop={3}>

                        {
                            PropertyTurkeyCarouselData.map((item) => {
                                return (
                                    <TurkeyPropertyComponent Description={item.Description} Img={item.img} />
