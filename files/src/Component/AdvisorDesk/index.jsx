...
export default function AdvisorDesk() {
    ...
    const onSubmit = async (data) => {
        console.log(Phone)
        const docRef = await addDoc(collection(db, "AdvisorDesk"), {...data,Phone});
                            ...
                            <div className="adviser-form-container h100">
                                ...
                                >
                                    <div className={`step1 step ${stepVisible ? 'hide':''}`}>
                                        ...
                                        <div className="text-center" onClick={()=>setVisible(true)}>
                                            <button   className="adviser-form--btn" id="adviser-form-step-1">
                                                Next
                                            </button>
                                        </div>
                                    </div>
