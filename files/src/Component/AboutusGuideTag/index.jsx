          ...
          <article className="page-content col-dis-9 col-tab-9 col-mob-12 no-padding">
            ...
            >
              ...
              <h4>
                ...
                >
                  <strong className="text-[#5081ff]">Mission Statement</strong>
                </span>
              </h4>
              <p>
              ...
              <p>
                ...
                Property USA are your experienced, friendly, and independent
              ...
              <p>
                For us buying a property in USA is not about buying 'bricks and
              ...
              <p>
                ...
                USA stands head and shoulders above the rest. Our success in
                ...
                effective investment consultants for property in USA.
              </p>
              <p>
                <br />
              </p>
              {
                AboutDataGuide.map((item) => {
                  return (
                    <DisplayComponent title={item.title} Description={item.Description} img={item.img} />
                  )
                })
              }
              ...
              <DescriptionContent text=" Headed by director Cameron Deggin, our consultants work together to
                provide an unrivalled, specialised service in their respective
                fields and regions."/>
              <DescriptionContent text=" Headquartered in London with offices in Istanbul, Bodrum, Fethiye,
              ...
              <DescriptionContent text=" Property USA does not use agents or intermediaries. Each regional
                  ...
                  <Box className="card-body">
                    <Box className="row">
                      ...
                      <Box className="col-md-9 cameron-section-quotesbg flex items-center">
                        <DescriptionContent className="cameron-section-blackquote" text="“Property USA is different: our interests lie with you,
