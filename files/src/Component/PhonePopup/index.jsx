...
export default function PhonePopup() {
    ...
    return (
        <div className="social-iconss relative" id="s-icons">
            <ul className={`navbar-nav absolute -top-4 left-8 ${toggleBtn ? 'show' : ''}`}>
            ...
            >
                <Box className="flex relative px-1">
                    <BsFillTelephoneFill size={25} color="#fff" className="absolute -top-2" />
                    <TbMessageCircle2Filled size={25} color="#fff" className="absolute -top-4 right-0" />
                </Box>
