...
export default function BuyerGuidetag() {
  ...
  const filterDataInvest = [
    {
      link:'Why invest in property in Turkey'
    },
              ...
              <div className="container-fluid">
                ...
                <div className="padding-top-2 side-item">
                  <div className="buyer-guide--supertitle" >
                    ...
                    {
                      toggleInvesting? <FiChevronDown onClick={() => settoggleInvesting(!toggleInvesting)} className="tabs-icon" />:
                      <FiChevronUp onClick={() => settoggleInvesting(!toggleInvesting)} className="tabs-icon" />
                    }
                  </div>
                ...
                <div className="padding-top-2 side-item">
                  <div className="buyer-guide--supertitle">
                    ...
                    {
                      togglePurchase? <FiChevronDown onClick={() => settogglePurchase(!togglePurchase)} className="tabs-icon" aria-hidden="true" />:
                      <FiChevronUp onClick={() => settogglePurchase(!togglePurchase)} className="tabs-icon" aria-hidden="true" />


                    }
                  </div>
                  <ul className={`list-unstyled buyer-guide--ul ${togglePurchase ? '' : 'hide'}`}>
                    <li className="">
                      <Link
                    ...
                    <li className="">
                      <Link
                        ...
                        title="How to get a USA Title Deed"
                      >
                ...
                <div className="padding-top-2 side-item">
                  <div className="buyer-guide--supertitle">
                    ...
                    {
                      toggleResidency?<FiChevronDown onClick={() => settoggleResidency(!toggleResidency)} className="tabs-icon" aria-hidden="true" />:
                      <FiChevronUp onClick={() => settoggleResidency(!toggleResidency)} className="tabs-icon" aria-hidden="true" />
                    }
                  </div>
                ...
                <div className="padding-top-2 side-item">
                  <div className="buyer-guide--supertitle">
                    ...
                    {
                     togglepets?<FiChevronDown onClick={() => settogglepets(!togglepets)} className="tabs-icon" aria-hidden="true" />:
                     <FiChevronUp onClick={() => settogglepets(!togglepets)} className="tabs-icon" aria-hidden="true" />
                    }
                  </div>
                ...
                <div className="padding-top-2 side-item">
                  <div className="buyer-guide--supertitle">
                    ...
                    {
                     toggleproperty? <FiChevronDown onClick={() => settoggleproperty(!toggleproperty)} className="tabs-icon" aria-hidden="true" />:
                     <FiChevronUp onClick={() => settoggleproperty(!toggleproperty)} className="tabs-icon" aria-hidden="true" />
                    }
                  </div>
                  <ul className={`list-unstyled buyer-guide--ul ${toggleproperty ? '' : 'hide'}`}>
                    <li className="">
                      <Link
                        ...
                        title="Income Tax On USA Property"
                      >
                    ...
                    <li className="">
                      <Link
                        ...
                        title="Capital Gains Tax On Sale Of USA Property"
                      >
                    ...
                    <li className="">
                      <Link
                        ...
                        title="VAT exemption when buying USA real estate"
                      >
                ...
                <div className="padding-top-2 side-item">
                  <div className="buyer-guide--supertitle">
                    ...
                    {
                      toggleLiving?<FiChevronDown onClick={() => settoggleLiving(!toggleLiving)} className="fa fa-angle-up tabs-icon" aria-hidden="true" />:
                      <FiChevronUp onClick={() => settoggleLiving(!toggleLiving)} className="fa fa-angle-up tabs-icon" aria-hidden="true" />
                    }
                  </div>
